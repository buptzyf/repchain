...
public class HttpsToRepChain4BC {
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            {
                System.out.println(urlStr + "="+new String(buffer, 0, length));
            }
        }
        catch (Exception e)
        {
...
class CipherSuiteOfSSLSocketFactory extends SSLSocketFactory
{
    ...
    public CipherSuiteOfSSLSocketFactory(SSLSocketFactory delegate)
    {
