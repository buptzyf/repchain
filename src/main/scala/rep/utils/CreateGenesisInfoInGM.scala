...
object CreateGenesisInfoInGM {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val deploy_trans = PeerHelper.createTransaction4Deploy(superAdmin, cid1, l1, "", 5000, CodeType.CODE_SCALA,RunType.RUN_SERIAL,StateType.STATE_BLOCK,
    ...
    val dep_asserts_trans = PeerHelper.createTransaction4Deploy(sysName, cid2, c2, "", 5000, CodeType.CODE_SCALA,RunType.RUN_SERIAL,StateType.STATE_BLOCK,
      ChaincodeDeploy.ContractClassification.CONTRACT_SYSTEM,0)
