...
import rep.network.consensus.util.BlockHelp.versionOfBlock
...
import rep.proto.rc2.{Block, BlockHeader, ChaincodeId, Operate, Transaction}
...
object CreateGenesisInfo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val deploy_trans = PeerHelper.createTransaction4Deploy(superAdmin, cid1, l1, "", 5000,
    ...
    val dep_asserts_trans = PeerHelper.createTransaction4Deploy(sysName, cid2, c2, "", 5000, rep.proto.rc2.ChaincodeDeploy.CodeType.CODE_SCALA,
    ...
    var blk = new Block(
      Option(new BlockHeader(2,1,null,null,ByteString.EMPTY, ByteString.EMPTY,
        null,null,0,null)),
      translist, Seq(), Map.empty,Map.empty, null)
