...
import rep.network.consensus.cfrd.MsgOfCFRD.{BlockInfoOfConsensus, EndorsementInfo, RequesterOfEndorsement, ResendEndorseInfo, ResultFlagOfEndorse, ResultOfEndorseRequester, ResultOfEndorsed}
...
*/
  override def receive = {
    case BlockInfoOfConsensus(voteinfo,blocker,blc,currentBlockSerial,isFirst,isLastBlock) =>
      ...
      /*if(this.isChangeBlocker(voteinfo)){
